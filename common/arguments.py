...
def parse_args():
    ...
    parser.add_argument('--lr_decay_large', type=float, default=0.95)
    parser.add_argument('--lr_decay_epoch', type=int, default=5)
    parser.add_argument('--workers', type=int, default=16)
    parser.add_argument('-lrd', '--lr_decay', default=1, type=float)
    ...
    parser.add_argument('--conv_large', type=int, default=7)
    parser.add_argument('--gn_large', type=int, default=8)
    parser.add_argument('--num_heads', type=int, default=8)
    parser.add_argument('--sga_size', type=int, default=11)
